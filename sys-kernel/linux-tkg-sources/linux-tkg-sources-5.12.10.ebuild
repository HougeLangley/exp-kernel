...
https://raw.githubusercontent.com/Frogging-Family/linux-tkg/master/linux-tkg-patches/5.12/0004-glitched-muqss.patch
https://raw.githubusercontent.com/Frogging-Family/linux-tkg/master/linux-tkg-patches/5.12/0004-glitched-ondemand-muqss.patch
...
"${DISTDIR}/0004-glitched-muqss.patch"
"${DISTDIR}/0004-glitched-ondemand-muqss.patch"
...
src_prepare() {
	...
	if	use	muqss	;	then
		...
		eapply "${DISTDIR}/0002-clear-patches.patch"	||	die
		eapply "${DISTDIR}/0003-glitched-base.patch"	||	die
		eapply "${DISTDIR}/0004-glitched-ondemand-muqss.patch"	||	die
		eapply "${DISTDIR}/0004-glitched-muqss.patch"	||	die
